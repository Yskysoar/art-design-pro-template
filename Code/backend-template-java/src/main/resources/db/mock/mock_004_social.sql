...
VALUES
  (20, '设计稿-首屏卡片.webp', 'social-hero-card.webp', 'social/mock/social-hero-card.webp', '/src/assets/images/cover/img1.webp', 'image/webp', 'webp', 286000, 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'REMOTE', 5, 'designer'),
  (21, '交互走查清单.pdf', 'social-interaction-checklist.pdf', 'social/mock/social-interaction-checklist.pdf', 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf', 'application/pdf', 'pdf', 132640, 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb', 'REMOTE', 1, 'admin'),
  (22, '摄影棚灯光参考.webp', 'social-lighting-reference.webp', 'social/mock/social-lighting-reference.webp', '/src/assets/images/cover/img2.webp', 'image/webp', 'webp', 312000, 'cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc', 'REMOTE', 7, 'photographer'),
  (23, '素材命名规范.txt', 'social-asset-naming.txt', 'social/mock/social-asset-naming.txt', 'https://www.w3.org/TR/PNG/iso_8859-1.txt', 'text/plain', 'txt', 6120, 'dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd', 'REMOTE', 7, 'photographer'),
  (24, '产品页信息架构.webp', 'social-product-ia.webp', 'social/mock/social-product-ia.webp', '/src/assets/images/cover/img3.webp', 'image/webp', 'webp', 198000, 'eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', 'REMOTE', 8, 'producter'),
  (25, '作者投稿说明.docx', 'social-writer-guide.docx', 'social/mock/social-writer-guide.docx', 'https://file-examples.com/storage/fe9b2df2d66640a7b0f53e8/2017/02/file-sample_100kB.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'docx', 102400, 'ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 'REMOTE', 10, 'guest_writer'),
  (26, '运营排期表.xlsx', 'social-operation-calendar.xlsx', 'social/mock/social-operation-calendar.xlsx', 'https://file-examples.com/storage/fe9b2df2d66640a7b0f53e8/2017/02/file_example_XLSX_10.xlsx', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'xlsx', 13840, '1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef', 'REMOTE', 4, 'operator'),
  (27, '移动端验收截图.webp', 'social-mobile-check.webp', 'social/mock/social-mobile-check.webp', '/src/assets/images/cover/img4.webp', 'image/webp', 'webp', 225000, 'abcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcd', 'REMOTE', 9, 'tester');
